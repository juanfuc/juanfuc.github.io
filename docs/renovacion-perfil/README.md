...
4. **Documento de la ronda activa** — el trabajo en curso y sus criterios de aceptación. Ronda activa: **[`rondas/R01-base-estructural.md`](./rondas/R01-base-estructural.md)**.
...
- **[`rondas/R01-base-estructural.md`](./rondas/R01-base-estructural.md)** — primera ronda de implementación (base estructural). **Ronda activa.**
